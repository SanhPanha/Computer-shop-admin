...
const Login = () => {
  ...
  const onGoogleSignIn = async (e: any) => {
    ...
    if (!isSigningIn) {
      ...
      try {
        ...
        router.push('//categories/category'); // Navigate to the home page after Google sign-in
      } catch (err) {
  ...
  if (userLoggedIn) {
    router.push('/categories/category'); // Redirect to the home page if user is already logged in
